    ...
    return (
        <div className='form-container h-fit container mx-auto mb-14'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input className='border-black p-2 ml-11 rounded-md border-2 w-9/12 h-10' type="password"  name="password" required/>
                ...
                <p className='mt-3 text-md mb-2 ml-11'>New to Car Resale?<Link className="mx-3 text-red-700 font-bold text-xl" to="/register">Register</Link></p>
